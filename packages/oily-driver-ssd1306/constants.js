...
module.exports = {
  CONTROL_COMMAND: 0x00, // i2c control byte for commands
  CONTROL_DATA: 0x40, // i2c control byte for data

  // RAM has 128 columns and is addressed with two commands for the high and low nybble
  SET_COL_ADDR_LB: 0x00, // | [0x00 - 0x0F]
  SET_COL_ADDR_HB: 0x10, // | [0x00 - 0x83]

  // set the column start and end address for write operations
  SET_COL_ADDR_START: 0x21, // , [0x00 - 0x7F], [0x00 - 0x7F]
  ...
  // set page start and end values for writes
  SET_PAGE_ADDRESS_START: 0x22, // , [0x00 - 0x07], [0x00 - 0x07]
